...
function buildSystemMessage(msg) {
  ...
  Сообщения должны быть всегда в строгом формате:
  
  Пример 1:
  ---
  ChatGPT: Прошу прощения за ненормативную лексику, мы находимся в игре, не принимайте это на свой счёт
  
  Рассказчик: Пленник весь в крови с застёгнутыми наручниками к клетке, сидит с понурой головой
  ...
  Рассказчик: Вы находитесь в клетке из бамбука, в клетке сидят 3 пленика, один из них без сознания.
